        ...
        return (
            <div className="registerBlock">
                    ...
                    <div className="formContainer">
                        ...
                        <div className="emailContainer">
                            ...
                            <div className="emailinput">
                                <input className="mainInput" id="email"/>
                            </div>
                        </div>
                        ...
                        <div className="phoneContainer">
                            ...
                            <div className="phoneDropdown">
                                <div className="extensions">
                                    <select value={this.state.pExt} className="dropdown">
                                        <option value='IND +91' className="dropdownoption"> IND +91 </option>
                                        <option value='UK +44' className="dropdownoption"> UK +44 </option>
                                        <option value='US +1' className="dropdownoption"> US +1 </option>
                                    </select>
                                </div>
                                <div className="phoneNoinput">
                                    <input id="phone" className="contactinput"/>
                                </div>
                            </div>
                        ...
                        <div className="phoneContainer">
                            ...
                            <div className="phoneDropdown">
                                <div className="extensions">
                                    <select value={this.state.mExt} className="dropdown">
                                        <option value='IND +91' className="dropdownoption"> IND +91 </option>
                                        <option value='UK +44' className="dropdownoption"> UK +44 </option>
                                        <option value='USA +1' className="dropdownoption"> US +1 </option>
                                    </select>
                                </div>
                                <div className="phoneNoinput">
                                    <input id="mobile" className="contactinput"/>
                                </div>
                            </div>
                        </div>
                ...
                <div className="rightBlock">
                    <div className="staticloginbox"></div>
